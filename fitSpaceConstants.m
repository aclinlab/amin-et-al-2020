...
electroDistConstants = [624, 1249, 1873, 2381, 11180]; % k = .0559, 0.1118, 0.1677, 0.213, 1.0 m
...
% and Ra = 1.02 Ohm*m.
realDistConstants = electroDistConstants*5.0062; %this gives real distance space constant in pixels
